...
proc create_root_design { parentCell } {
  ...
  set pmod_miso_0 [ create_bd_port -dir I pmod_miso_0 ]
  set pmod_mosi_0 [ create_bd_port -dir O pmod_mosi_0 ]
  set pmod_sck_0 [ create_bd_port -dir O pmod_sck_0 ]
  set pmod_ss_0 [ create_bd_port -dir O pmod_ss_0 ]
  set resetn_0 [ create_bd_port -dir I -type rst resetn_0 ]
  set status_debug_0 [ create_bd_port -dir O -from 1 -to 0 status_debug_0 ]
  set status_error_0 [ create_bd_port -dir O status_error_0 ]
  set status_stage_0 [ create_bd_port -dir O -from 3 -to 0 status_stage_0 ]

  # Create instance: Pmod_NIC100_AXI_0, and set properties
  set block_name Pmod_NIC100_AXI
  set block_cell_name Pmod_NIC100_AXI_0
  if { [catch {set Pmod_NIC100_AXI_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Pmod_NIC100_AXI_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Pmod_NIC100_AXI_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net Pmod_NIC100_AXI_0_status_debug [get_bd_ports status_debug_0] [get_bd_pins Pmod_NIC100_AXI_0/status_debug]
  connect_bd_net -net Pmod_NIC100_AXI_0_status_error [get_bd_ports status_error_0] [get_bd_pins Pmod_NIC100_AXI_0/status_error]
  connect_bd_net -net Pmod_NIC100_AXI_0_status_stage [get_bd_ports status_stage_0] [get_bd_pins Pmod_NIC100_AXI_0/status_stage]
  ...
  connect_bd_net -net pmod_miso_0_1 [get_bd_ports pmod_miso_0] [get_bd_pins Pmod_NIC100_AXI_0/pmod_miso]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net resetn_0_1 [get_bd_ports resetn_0] [get_bd_pins clk_wiz/resetn]
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins Pmod_NIC100_AXI_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins rst_clk_wiz_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins blk_mem_gen_0/web] [get_bd_pins util_reduced_logic_0/Res]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins xlslice_0/Dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Pmod_NIC100_AXI_0/S_AXI/reg0] SEG_Pmod_NIC100_AXI_0_reg0
